...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_pageTransitions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/pageTransitions */ "./resources/js/utils/pageTransitions.js");
/* harmony import */ var _utils_scrollEffects__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/scrollEffects */ "./resources/js/utils/scrollEffects.js");
/* harmony import */ var _utils_touchEvents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/touchEvents */ "./resources/js/utils/touchEvents.js");




var init = function init() {
  (0,_utils_pageTransitions__WEBPACK_IMPORTED_MODULE_0__.initBarba)();
  (0,_utils_touchEvents__WEBPACK_IMPORTED_MODULE_2__.initTouchEvents)();
  (0,_utils_scrollEffects__WEBPACK_IMPORTED_MODULE_1__.initScrollEffects)();
};
...
/***/ "./resources/js/utils/pageTransitions.js":
/*!***********************************************!*\
  !*** ./resources/js/utils/pageTransitions.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _scrollEffects__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scrollEffects */ "./resources/js/utils/scrollEffects.js");
  ...
  _barba_core__WEBPACK_IMPORTED_MODULE_0___default().init({
    views: [{
      ...
      beforeEnter: function beforeEnter(data) {
        (0,_scrollEffects__WEBPACK_IMPORTED_MODULE_3__.initScrollEffects)();
        var regex = /<script[^>]*src=["']([^"']*)["']/g;
        var html = data.next.html;
        var startPage = html.indexOf('<!--BEGIN_PAGE');
        var endPage = html.indexOf('<!--END_PAGE');
        var match;

        while (match = regex.exec(html)) {
          var src = match[1];
          var index = html.indexOf(src);
          var inPage = index > startPage && index < endPage;
        ...
        aos__WEBPACK_IMPORTED_MODULE_2___default().init(); // setupParticles();
      },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initBarba);

/***/ }),

/***/ "./resources/js/utils/scrollEffects.js":
/*!*********************************************!*\
  !*** ./resources/js/utils/scrollEffects.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addScrollElements": () => (/* binding */ addScrollElements),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "initScrollEffects": () => (/* binding */ initScrollEffects)
/* harmony export */ });
...
window.lax = (lax_js__WEBPACK_IMPORTED_MODULE_0___default());
var scrollY = {
  scale: [["elInY", "elOutY"], [1.6, 1]],
  // blur: [
  //     ["elInY", "elCenterY"],
  //     [5, 0],
  // ],
  rotate: [["elInY", "elOutY"], [6, 0]],
  opacity: [["elInY", "elCenterY"], [0.75, 1]]
};
var addScrollElements = function addScrollElements() {
  window.lax.elements = [];
  window.lax.addElements('.scroll-effect', {
    scrollY: scrollY
  });
};
var initScrollEffects = function initScrollEffects() {
  window.lax.init();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initScrollEffects);

/***/ }),

/***/ "./resources/js/utils/touchEvents.js":
/*!*******************************************!*\
  !*** ./resources/js/utils/touchEvents.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initTouchEvents": () => (/* binding */ initTouchEvents)
/* harmony export */ });
...
var initTouchEvents = function initTouchEvents() {
  ...
  var handler = new tinygesture__WEBPACK_IMPORTED_MODULE_0__["default"](body);
  handler.on('swiperight', function (e) {
    if (e.target.hasAttribute('data-carousel-id')) {
      var id = e.target.dataset.carouselId;
      var prev = document.querySelector("[data-carousel-prev=\"".concat(id, "\"]"));
      prev.dispatchEvent(new Event('click'));
    }
  });
  handler.on('swipeleft', function (e) {
    if (e.target.hasAttribute('data-carousel-id')) {
      var id = e.target.dataset.carouselId;
      var next = document.querySelector("[data-carousel-next=\"".concat(id, "\"]"));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TinyGesture)
/* harmony export */ });
/**
 * TinyGesture.js
 *
